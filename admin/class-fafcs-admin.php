...
class FAFCS_Admin {
	 ...
	 * dashboard. Styles will be registered only for fafcs pages for performance.
	 *
	 * @since 2.0.0
	...
	public function enqueue_styles() {
		...
		if ( ( $pagenow == 'options-general.php' ) && ( in_array( $_GET['page'], array( 'fafcs-settings' ) ) ) ) {
	 ...
	 * @return void
	 */
	public function create_fafcs_menu() {

		add_options_page(
			__( 'Future Aim Social Comment system', 'future-aim-social-comments' ),
			__( 'Future Aim Social Comment system', 'future-aim-social-comments' ),
			FAFCS_ADMIN_PERMISSION,
			'fafcs-settings',
	...
	public function admin_page() {
		...
		require plugin_dir_path( __FILE__ ) . 'partials/fafcs-admin-display.php';
	}
	...
	/**
	 * Custom footer text for FAFCS pages.
	 *
	 * @since 2.0.0
	 *
	 * @return mixed
	...
	public function dashboard_footer() {
		...
		if ( ( $pagenow == 'options-general.php' ) && ( in_array( $_GET['page'], array( 'fafcs-settings' ) ) ) ) {
			...
			_e( 'Thank you for choosing Future Aim Social Comment system to improve your website', 'future-aim-social-comments' );
			echo ' | ';
			_e( 'Kindly give this plugin a ', 'future-aim-social-comments' );
			echo '<a href="https://wordpress.org/support/view/plugin-reviews/future-aim-social-comments?filter=5#postform">';
			_e( 'rating', 'future-aim-social-comments' );
			echo ' &#9733; &#9733; &#9733; &#9733; &#9733;</a>';
		} else {
			return;
		}
	 ...
	 *
	 * Function to add a quick link to fafcs,
	...
	public function plugin_action_links( $links, $file ) {
		...
		$plugin_file = basename( 'future-aim-social-comments.php' );

		if ( basename( $file ) == $plugin_file ) {

			$settings_link = '<a href="options-general.php?page=fafcs-settings&tab=general">' . __( 'Settings', 'future-aim-social-comments' ) . '</a>';
